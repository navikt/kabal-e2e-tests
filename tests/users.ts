...
export const SAKEN_GJELDER: Part = { id: { type: PartType.PERSON, verdi: '26477435792' } };
...
export const SAKEN_GJELDER_DATA = { id: formatIdNumber(SAKEN_GJELDER.id.verdi), name: 'FLYKTIG TANKE' };
